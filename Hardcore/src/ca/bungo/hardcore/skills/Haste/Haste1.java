...
public class Haste1 extends Skill {

	public Haste1(Hardcore hardcore, String name) {
		super(hardcore, name);
		this.cost = 3;
		this.desc = "Gain a costant Haste 1 effect!";
		this.tier = 1;
		this.family = "HST";
	}
	...
	public boolean purchaseSkill(PlayerData data) {
		Bukkit.getPlayer(UUID.fromString(data.uuid)).addPotionEffect(new PotionEffect(PotionEffectType.FAST_DIGGING, 99999999, 0));
